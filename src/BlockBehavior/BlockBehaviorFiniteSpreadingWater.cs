...
{
    public class BlockBehaviorFiniteSpreadingWater : BlockBehavior
    {
        ...
        public BlockBehaviorFiniteSpreadingWater(Block block) : base(block)
        {
        }
        ...
        private bool IsSameLiquid(Block block, Block other)
        {
            return block.LiquidCode == other.LiquidCode
                ||
                // dominionsmod
                (block.Code.ToString().Contains("water") && other.Code.ToString().Contains("water"));
        }
        ...
        public bool CanSpreadIntoBlock(Block ourblock, Block neighborBlock, IWorldAccessor world)
        {
            bool isSameLiquid = neighborBlock.LiquidCode == ourblock.LiquidCode
                ||
                // dominionsmod
                (block.Code.ToString().Contains("water") && neighborBlock.Code.ToString().Contains("water"));
